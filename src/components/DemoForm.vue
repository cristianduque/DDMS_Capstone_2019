      ...
      <v-layout row wrap>
        <v-flex>
          <v-toolbar color="red" dark>
            <v-toolbar-title >Formulario Demostración</v-toolbar-title>
            <v-spacer></v-spacer>
          </v-toolbar>
          <v-form>
            <v-card>
              <v-card-title primary-title>
                <h4>Tienda:__________     Pueblo:___________</h4>
                <h4>Demostradora:__________</h4>
              </v-card-title>
              <v-card-text>
        ...
        <v-text-field label="Precio Regular"  type="number" v-model="n.PrecioRegular" required></v-text-field>
         ...
         <v-text-field label="Total" v-model="total" type="number" @click= "calculateTotal"readonly></v-text-field>
              ...
              <v-card>
                <v-card-text>
                  <v-text-field label="Nombre Empleado Tienda" v-model="empleadoTienda" type="text" clear-icon="mdi-close-circle" clearable></v-text-field>





                  <v-text-field label="Puesto Empleado" v-model="empleadoPuesto" type="text"></v-text-field>
                </v-card-text>
              </v-card>

              <v-card-actions>
                <div class="submit_button">
                  <v-btn type="button" @click="postListData" >Submit</v-btn>
                </div>
              </v-card-actions>
            </v-card>
            <br>
